...
class EnhancedDriverButtons {
    ...
    async handleUpdateFuel() {
        ...
        // CRITICAL: Use DriverSystemV3 for fuel updates to avoid conflicts
        if (window.driverSystemV3 && typeof window.driverSystemV3.showFuelModal === 'function') {
            console.log('🔄 Delegating fuel update to DriverSystemV3');
            window.driverSystemV3.showFuelModal();
            return;
        }
